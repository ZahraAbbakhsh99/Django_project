...
urlpatterns = [
    ...
    path('orderhistory/<int:user_id>', views.user_order_history, name='user_order_history'),
    path('orderconfirmation/<int:order_id>', views.confirm_order, name='confirm_order'),
